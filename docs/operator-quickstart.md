# Operator Quickstart — Other Specialized Construction Activities

Shortest path from clone to a verified local dry-run for **ISIC 4390** (`cloud-itonami-isic-4390`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4390.git
cd cloud-itonami-isic-4390
```
...
- Blueprint governor key: `specialized-governor`
- Likely source path: `specialized.governor.cljc`
